# Capability Statement Chunking Analysis
*Generated on: 2025-07-02 13:56:55*

## 📊 Summary Statistics
- **Total chunks**: 13
- **Average chunk length**: 2078.8 characters
- **Shortest chunk**: 603 characters
- **Longest chunk**: 3291 characters


## 📋 Table of Contents
- [Chunk 1](#chunk-1) (603 chars): FHIR Document Title: # CapabilityStatement: Plan\-...
- [Chunk 2](#chunk-2) (996 chars): FHIR Major Section: ## CapabilityStatement: Plan\-...
- [Chunk 3](#chunk-3) (802 chars): FHIR Major Section: ## Plan\-Net CapabilityStateme...
- [Chunk 4](#chunk-4) (1169 chars): FHIR Resource/Component: ### FHIR RESTful Capabili...
- [Chunk 5](#chunk-5) (3288 chars): FHIR Resource/Component: ### RESTful Capabilities...
- [Chunk 6](#chunk-6) (1184 chars): FHIR Resource Detail: #### Endpoint  Conformance E...
- [Chunk 7](#chunk-7) (3036 chars): FHIR Resource Detail: #### HealthcareService  Conf...
- [Chunk 8](#chunk-8) (2302 chars): FHIR Resource Detail: #### InsurancePlan  Conforma...
- [Chunk 9](#chunk-9) (2809 chars): FHIR Resource Detail: #### Location  Conformance E...
- [Chunk 10](#chunk-10) (3225 chars): FHIR Resource Detail: #### Organization  Conforman...
- [Chunk 11](#chunk-11) (3291 chars): FHIR Resource Detail: #### OrganizationAffiliation...
- [Chunk 12](#chunk-12) (1466 chars): FHIR Resource Detail: #### Practitioner  Conforman...
- [Chunk 13](#chunk-13) (2854 chars): FHIR Resource Detail: #### PractitionerRole  Confo...
...
**Content:**
```
FHIR Document Title: # CapabilityStatement: Plan\-Net CapabilityStatement
...
**Content:**
```
FHIR Major Section: ## CapabilityStatement: Plan\-Net CapabilityStatement
...
**Content:**
```
FHIR Major Section: ## Plan\-Net CapabilityStatement
...
**Content:**
```
FHIR Resource/Component: ### FHIR RESTful Capabilities
...
**Content:**
```
FHIR Resource/Component: ### RESTful Capabilities by Resource/Profile:
...
### Chunk 7
**Length**: 3036 characters  
**ID**: 6  

**Content:**
```
FHIR Resource Detail: #### HealthcareService
...
**Content:**
```
FHIR Resource Detail: #### InsurancePlan
...
### Chunk 9
**Length**: 2809 characters  
**ID**: 8  

**Content:**
```
FHIR Resource Detail: #### Location
...
**Content:**
```
FHIR Resource Detail: #### Organization
...
**Content:**
```
FHIR Resource Detail: #### OrganizationAffiliation
...
**Content:**
```
FHIR Resource Detail: #### Practitioner
...
**Content:**
```
FHIR Resource Detail: #### PractitionerRole

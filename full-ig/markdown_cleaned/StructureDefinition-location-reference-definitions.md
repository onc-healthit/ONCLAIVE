# Extension: LocationReference - Detailed Descriptions
...
Definitions for the location-reference extension.
...
| Fixed Value | http://hl7.org/fhir/us/davinci-pdex-plan-net/StructureDefinition/location-reference |
| 5. **Extension.value[x]** | |

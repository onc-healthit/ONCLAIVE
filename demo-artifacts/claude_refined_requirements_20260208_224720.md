...
I have carefully analyzed all the provided FHIR Implementation Guide text chunks. After filtering out non-testable content such as value set definitions, code system definitions, mapping tables, informational pages, example instances, and placeholder testing pages, I have identified and extracted all testable requirements.

Here is the complete refined list of testable requirements:
...
# REQ-002
**ID**: 02
**Summary**: Support for Location address search parameter
**Requirement**: "Select Locations with the specified address"
**Context**: The Plan-Net implementation guide defines a search parameter 'address' of type 'string' for the Location resource. The parameter uses the expression 'Location.address' and supports multipleAnd (parameter may repeat to specify multiple values that must all be true) and multipleOr (parameter may have multiple values separated by comma where at least one must be true). Allowed modifiers are 'exact' and 'contains'.
**Conformance**: SHALL
...
# REQ-003
**ID**: 03
**Summary**: Support for Organization type search parameter
**Requirement**: "Select Organizations of the specified type"
**Context**: The Plan-Net implementation guide defines a search parameter 'type' of type 'token' for the Organization resource. The parameter uses the expression 'Organization.type' and supports multipleAnd (parameter may repeat to specify multiple values that must all be true) and multipleOr (parameter may have multiple values separated by comma where at least one must be true). Allowed modifier is 'text'.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-004
**ID**: 04
**Summary**: Support for InsurancePlan name search parameter
**Requirement**: "Select products with the specified name"
**Context**: The Plan-Net implementation guide defines a search parameter 'name' of type 'string' for the InsurancePlan resource. The parameter uses the expression 'name | alias' and supports multipleAnd (parameter may repeat to specify multiple values that must all be true) and multipleOr (parameter may have multiple values separated by comma where at least one must be true). Allowed modifiers are 'exact' and 'contains'.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-005
**ID**: 05
**Summary**: Server SHALL support search by type parameter on InsurancePlan resource
**Requirement**: "Select insurance plans of the specified type"
**Context**: The Plannet_sp_insuranceplan_type search parameter is defined to allow searching for InsurancePlan resources filtered by their type. The parameter uses token type searching on the InsurancePlan.type element with support for multipleAnd (parameter may repeat for values that must all be true) and multipleOr (parameter may have comma-separated values where at least one must be true). The text modifier is allowed.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-006
**ID**: 06
**Summary**: Server SHALL support search by name parameter on Organization resource
**Requirement**: "Select Organizations with the specified name"
**Context**: The Plannet_sp_organization_name search parameter is defined to allow searching for Organization resources filtered by their name or alias. The parameter uses string type searching on the Organization.name and Organization.alias elements with support for multipleAnd (parameter may repeat for values that must all be true) and multipleOr (parameter may have comma-separated values where at least one must be true). The exact and contains modifiers are allowed.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-007
**ID**: 07
**Summary**: Server SHALL support search by address-city parameter on Location resource
**Requirement**: "Select Locations with the specified address.city [using Parameter `address-city`:`string` with Expression `Location.address.city`]"
**Context**: This requirement specifies that a server implementing the Plan-Net Implementation Guide must support searching for Location resources using the address-city search parameter. The parameter is of type string and searches against the Location.address.city element. The parameter supports multipleAnd (repeating the parameter to specify multiple values that must all be true) and multipleOr (comma-separated values where at least one must be true). Allowed modifiers are exact and contains.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Select plans of the specified type [using Parameter `plan-type`:`token` with Expression `InsurancePlan.plan.type`]"
**Context**: This requirement specifies that a server implementing the Plan-Net Implementation Guide must support searching for InsurancePlan resources using the plan-type search parameter. The parameter is of type token and searches against the InsurancePlan.plan.type element. The parameter supports multipleAnd (repeating the parameter to specify multiple values that must all be true) and multipleOr (comma-separated values where at least one must be true). Allowed modifier is text.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-009
**ID**: 09
**Summary**: Server SHALL support search by endpoint parameter on Location resource
**Requirement**: "Select Locations with the specified endpoint [using Parameter `endpoint`:`reference` with Expression `Location.endpoint`]"
**Context**: This requirement specifies that a server implementing the Plan-Net Implementation Guide must support searching for Location resources using the endpoint search parameter. The parameter is of type reference and searches against the Location.endpoint element, targeting Endpoint resources. The parameter supports multipleAnd (repeating the parameter to specify multiple values that must all be true) and multipleOr (comma-separated values where at least one must be true). Allowed chain is organization.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-010
**ID**: 10
**Summary**: Server SHALL support search by role parameter on PractitionerRole resource
**Requirement**: "Select PractitionerRoles with the specified role [using Parameter `role`:`token` with Expression `PractitionerRole.code`]"
**Context**: This requirement specifies that a server implementing the Plan-Net Implementation Guide must support searching for PractitionerRole resources using the role search parameter. The parameter is of type token and searches against the PractitionerRole.code element. The parameter supports multipleAnd (repeating the parameter to specify multiple values that must all be true) and multipleOr (comma-separated values where at least one must be true). Allowed modifier is text.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Select Organization entries in a given InsurancePlan's network [using Parameter `network`:`reference` with Expression `InsurancePlan.network`]"
**Context**: This requirement specifies that a server implementing the Plan-Net Implementation Guide must support searching for InsurancePlan resources using the network search parameter. The parameter is of type reference and searches against the InsurancePlan.network element. The parameter supports multipleOr (comma-separated values where at least one must be true). For multipleAnd, it is up to the server whether the parameter may repeat to specify multiple values that must all be true.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Context**: The Plannet_sp_practitioner_given_name search parameter enables searching for Practitioner resources by the given name element. The parameter supports multipleAnd (multiple values that must all be true) and multipleOr (multiple comma-separated values where at least one must be true) semantics. The 'exact' modifier is allowed for precise matching.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Context**: The Plannet_sp_healthcareservice_name search parameter enables searching for HealthcareService resources by name. The parameter supports multipleAnd (multiple values that must all be true) and multipleOr (multiple comma-separated values where at least one must be true) semantics. The 'exact' and 'contains' modifiers are allowed.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Context**: The Plannet_sp_location_address_state search parameter enables searching for Location resources by the state component of the address. The parameter supports multipleAnd (multiple values that must all be true) and multipleOr (multiple comma-separated values where at least one must be true) semantics. The 'exact' and 'contains' modifiers are allowed.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-015
**ID**: 15
**Summary**: Server SHALL support search by partof on Location resource
...
**Context**: The Plannet_sp_location_partof search parameter enables searching for Location resources that are part of another specified location via the partOf reference. The parameter supports multipleOr (multiple comma-separated values where at least one must be true) semantics. Chaining is allowed on 'type', 'address', and 'organization' parameters. MultipleAnd support is at server discretion.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-016
**ID**: 16
**Summary**: InsurancePlan search parameter support for identifier with multipleAnd
**Requirement**: "The parameter may repeat in order to specify multiple values that must all be true"
**Context**: The InsurancePlan resource SHALL support the identifier search parameter with multipleAnd capability, allowing multiple identifier values to be specified where all must match for a resource to be returned.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-017
**ID**: 17
**Summary**: InsurancePlan search parameter support for identifier with multipleOr
**Requirement**: "The parameter may have multiple values (separated by comma) where at least one must be true"
**Context**: The InsurancePlan resource SHALL support the identifier search parameter with multipleOr capability, allowing comma-separated identifier values where at least one must match for a resource to be returned.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-018
**ID**: 18
**Summary**: Practitioner search parameter support for family name with multipleAnd
**Requirement**: "The parameter may repeat in order to specify multiple values that must all be true"
**Context**: The Practitioner resource SHALL support the family name search parameter with multipleAnd capability, allowing multiple family name values to be specified where all must match for a resource to be returned.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-019
**ID**: 19
**Summary**: Practitioner search parameter support for family name with multipleOr
**Requirement**: "The parameter may have multiple values (separated by comma) where at least one must be true"
**Context**: The Practitioner resource SHALL support the family name search parameter with multipleOr capability, allowing comma-separated family name values where at least one must match for a resource to be returned.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-020
**ID**: 20
**Summary**: Organization search parameter support for endpoint with multipleAnd
**Requirement**: "The parameter may repeat in order to specify multiple values that must all be true"
**Context**: The Organization resource SHALL support the endpoint search parameter with multipleAnd capability, allowing multiple endpoint values to be specified where all must match for a resource to be returned.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-021
**ID**: 21
**Summary**: Organization search parameter support for endpoint with multipleOr
**Requirement**: "The parameter may have multiple values (separated by comma) where at least one must be true"
**Context**: The Organization resource SHALL support the endpoint search parameter with multipleOr capability, allowing comma-separated endpoint values where at least one must match for a resource to be returned.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-022
**ID**: 22
**Summary**: Server SHALL support practitioner search by name parameter
**Requirement**: "Select Practitioners with the specified name (matches against any of the elements in the HumanName data type)"
**Context**: This search parameter enables searching for Practitioner resources using the name parameter, which matches against any element in the HumanName data type. The parameter supports multipleAnd (multiple values must all be true) and multipleOr (at least one of multiple comma-separated values must be true) semantics. Allowed modifiers are 'exact' and 'contains'.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-023
**ID**: 23
**Summary**: Server SHALL support organization search by period parameter
**Requirement**: "Select Organization entries available during the specified period"
**Context**: This search parameter enables searching for Organization resources using the period parameter to filter organizations that are available during a specified time period. The period is extracted from the organization-period extension. The parameter supports multipleOr semantics (at least one of multiple comma-separated values must be true), and it is up to the server whether multipleAnd is supported.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-024
**ID**: 24
**Summary**: Server SHALL support location search by address-postalcode parameter
**Requirement**: "Select Locations with the specified address [postal code]"
**Context**: This search parameter enables searching for Location resources using the address-postalcode parameter to filter locations by postal code. The parameter supports multipleAnd (multiple values must all be true) and multipleOr (at least one of multiple comma-separated values must be true) semantics. Allowed modifiers are 'exact' and 'contains'.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-025
**ID**: 25
**Summary**: Server SHALL support organization search by partof parameter
**Requirement**: "Select Organizations that are part of the specified organization"
**Context**: This search parameter enables searching for Organization resources using the partof parameter to filter organizations that are part of a specified parent organization. The parameter supports multipleAnd (multiple values must all be true) and multipleOr (at least one of multiple comma-separated values must be true) semantics. Allowed chains are: name, address, type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Parameter `service-type`:`token` Select HealthcareServices of the specified type [with] Expression `HealthcareService.type` [and] multipleAnd: The parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true [and] Modifiers Allowed: text"
**Context**: This search parameter enables searching for HealthcareService resources by service type using the HealthcareService.type element. The parameter supports both AND and OR logic for multiple values and allows the text modifier.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Parameter `organization`:`reference` Select Endpoints managed by the specified organization [with] Expression `Endpoint.managingOrganization` [with] Target Resources [Organization] [and] multipleAnd: The parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true [and] Chains Allowed: name, address, partof, type"
**Context**: This search parameter enables searching for Endpoint resources by managing organization using the Endpoint.managingOrganization element. The parameter supports both AND and OR logic for multiple values and allows chaining on name, address, partof, and type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Parameter `period`:`date` Select Practitioner entries available during the specified period [with] Expression `Practitioner.extension.where(url='http://hl7.org/fhir/us/davinci-pdex-plan-net/StructureDefinition/practitioner-period').value` [and] multipleAnd: It's up to the server whether the parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true"
**Context**: This search parameter enables searching for Practitioner resources by availability period using the practitioner-period extension. The parameter supports OR logic for multiple values, and AND logic support is at server discretion.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Parameter `organization`:`reference` Select Locations managed by the specified organization [with] Expression `Location.managingOrganization` [with] Target Resources [Organization] [and] multipleAnd: The parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true [and] Chains Allowed: name, address, partof, type"
**Context**: This search parameter enables searching for Location resources by managing organization using the Location.managingOrganization element. The parameter supports both AND and OR logic for multiple values and allows chaining on name, address, partof, and type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Parameter `specialty`:`token` Select PractitionerRoles associated with the specified specialty [with] Expression `PractitionerRole.specialty` [and] multipleAnd: The parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true [and] Modifiers Allowed: text"
**Context**: This search parameter enables searching for PractitionerRole resources by specialty using the PractitionerRole.specialty element. The parameter supports both AND and OR logic for multiple values and allows the text modifier.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Select services associated with the specified specialty [using] Parameter `specialty`:`token` [where] Expression `HealthcareService.specialty` [and] multipleAnd: The parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true [with] Modifiers Allowed: text"
**Context**: This search parameter enables queries to filter HealthcareService resources based on their specialty using token-based search. The parameter supports both multipleAnd (requiring all specified values to match) and multipleOr (requiring at least one value to match) semantics, with text modifier support for partial matching.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Select organizations with the specified address (matches any of the string elements of an address) [using] Parameter `address`:`string` [where] Expression `Organization.address` [and] multipleAnd: The parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true [with] Modifiers Allowed: exact, contains"
**Context**: This search parameter enables queries to filter Organization resources based on any string element within their address using string-based search. The parameter supports both multipleAnd and multipleOr semantics, with exact and contains modifiers for precise or partial matching.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Select products that are owned by the specified organization [using] Parameter `owned-by`:`reference` [where] Expression `InsurancePlan.ownedBy` [with] Target Resources [Organization] [and] multipleAnd: The parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true [with] Chains Allowed: name, partof"
**Context**: This search parameter enables queries to filter InsurancePlan resources based on the owning organization using reference-based search. The parameter supports both multipleAnd and multipleOr semantics, with chained parameters (name, partof) to allow searches based on attributes of the referenced Organization resource.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Requirement**: "Select PractitionerRoles with the specified endpoint [using] Parameter `endpoint`:`reference` [where] Expression `PractitionerRole.endpoint` [with] Target Resources [Endpoint] [and] multipleAnd: The parameter may repeat in order to specify multiple values that must all be true [and] multipleOr: The parameter may have multiple values (separated by comma) where at least one must be true [with] Chains Allowed: organization"
**Context**: This search parameter enables queries to filter PractitionerRole resources based on their associated endpoint using reference-based search. The parameter supports both multipleAnd and multipleOr semantics, with chained parameter (organization) to allow searches based on attributes of the referenced Endpoint resource.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-035
**ID**: 35
**Summary**: Server SHALL support searching OrganizationAffiliation by role parameter
**Requirement**: "Select OrganizationAffiliations with the specified role [using Parameter `role`:`token` on Resource OrganizationAffiliation with Expression `OrganizationAffiliation.code`]"
**Context**: This search parameter enables searching for OrganizationAffiliation resources based on the role code. The parameter is of type token, uses the expression OrganizationAffiliation.code, supports both multipleAnd (multiple parameter repetitions must all be true) and multipleOr (comma-separated values where at least one must be true), and allows the text modifier.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-036
**ID**: 36
**Summary**: Server SHALL support searching InsurancePlan by coverage-area parameter
**Requirement**: "Select products that are offered in the specified location [using Parameter `coverage-area`:`reference` on Resource InsurancePlan with Expression `InsurancePlan.coverageArea` targeting Location resources]"
**Context**: This search parameter enables searching for InsurancePlan resources based on the coverage area location reference. The parameter is of type reference, uses the expression InsurancePlan.coverageArea, targets Location resources, and supports both multipleAnd (multiple parameter repetitions must all be true) and multipleOr (comma-separated values where at least one must be true).
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-037
**ID**: 37
**Summary**: Server SHALL support searching HealthcareService by service-category parameter
**Requirement**: "Select HealthcareServices providing the specified category of services [using Parameter `service-category`:`token` on Resource HealthcareService with Expression `HealthcareService.category`]"
**Context**: This search parameter enables searching for HealthcareService resources based on the service category. The parameter is of type token, uses the expression HealthcareService.category, supports both multipleAnd (multiple parameter repetitions must all be true) and multipleOr (comma-separated values where at least one must be true), and allows the text modifier.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-038
**ID**: 38
**Summary**: Server SHALL support searching HealthcareService by endpoint parameter
**Requirement**: "Select HealthcareServices with the specified endpoint [using Parameter `endpoint`:`reference` on Resource HealthcareService with Expression `HealthcareService.endpoint` targeting Endpoint resources]"
**Context**: This search parameter enables searching for HealthcareService resources based on the endpoint reference. The parameter is of type reference, uses the expression HealthcareService.endpoint, targets Endpoint resources, supports both multipleAnd (multiple parameter repetitions must all be true) and multipleOr (comma-separated values where at least one must be true), and allows chaining with the organization parameter.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-039
**ID**: 39
**Summary**: Server SHALL support searching PractitionerRole by service reference parameter
**Requirement**: "Parameter `service`:`reference` - Select PractitionerRoles providing the specified service [with] Expression `PractitionerRole.healthcareService`"
**Context**: The PractitionerRole resource must be searchable by the service search parameter, which is a reference type parameter that queries the PractitionerRole.healthcareService element. This search parameter enables filtering PractitionerRoles by the healthcare services they provide, targeting HealthcareService resources. The parameter supports multipleAnd (multiple values that must all be true) and multipleOr (at least one of multiple comma-separated values must be true). Allowed chains include: service-category, organization, location.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-040
**ID**: 40
**Summary**: Server SHALL support searching PractitionerRole by practitioner reference parameter
**Requirement**: "Parameter `practitioner`:`reference` - Select roles filled by the specified practitioner [with] Expression `PractitionerRole.practitioner`"
**Context**: The PractitionerRole resource must be searchable by the practitioner search parameter, which is a reference type parameter that queries the PractitionerRole.practitioner element. This search parameter enables filtering PractitionerRoles by the practitioner who fills the role, targeting Practitioner resources. The parameter supports multipleAnd (multiple values that must all be true) and multipleOr (at least one of multiple comma-separated values must be true). Allowed chain: name.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-041
**ID**: 41
**Summary**: Server SHALL support searching OrganizationAffiliation by period date parameter
**Requirement**: "Parameter `period`:`date` - Select Organization Affiliations available in the specified period [with] Expression `OrganizationAffiliation.period`"
**Context**: The OrganizationAffiliation resource must be searchable by the period search parameter, which is a date type parameter that queries the OrganizationAffiliation.period element. This search parameter enables filtering Organization Affiliations by their period of availability. The parameter supports multipleOr (at least one of multiple comma-separated values must be true), and multipleAnd support is at the server's discretion.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-042
**ID**: 42
**Summary**: Server SHALL support searching PractitionerRole by location reference parameter
**Requirement**: "Parameter `location`:`reference` - Select PractitionerRoles available at the specified location [with] Expression `PractitionerRole.location`"
**Context**: The PractitionerRole resource must be searchable by the location search parameter, which is a reference type parameter that queries the PractitionerRole.location element. This search parameter enables filtering PractitionerRoles by the locations where they are available, targeting Location resources. The parameter supports multipleAnd (multiple values that must all be true) and multipleOr (at least one of multiple comma-separated values must be true). Allowed chains include: address, address-postalcode, address-city, address-state, organization, type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-043
**ID**: 43
**Summary**: Server SHALL support searching OrganizationAffiliation by specialty token parameter
**Requirement**: "Parameter `specialty`:`token` - Select OrganizationAffiliations associated with the specified specialty [with] Expression `OrganizationAffiliation.specialty`"
**Context**: The OrganizationAffiliation resource must be searchable by the specialty search parameter, which is a token type parameter that queries the OrganizationAffiliation.specialty element. This search parameter enables filtering Organization Affiliations by their associated specialty. The parameter supports multipleAnd (multiple values that must all be true) and multipleOr (at least one of multiple comma-separated values must be true). Allowed modifier: text.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-044
**ID**: 44
**Summary**: Server SHALL support search parameter 'location' on HealthcareService resource
**Requirement**: "Parameter `location`:`reference` - Select HealthcareServices available at the specified location. Expression `HealthcareService.location`. The parameter may repeat in order to specify multiple values that must all be true (multipleAnd). The parameter may have multiple values (separated by comma) where at least one must be true (multipleOr). Chains Allowed: address, address-postalcode, address-city, address-state, organization, type"
**Context**: This search parameter enables querying HealthcareService resources by their location reference, with support for multiple value combinations and chained searches on location attributes including address components, organization, and type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-045
**ID**: 45
**Summary**: Server SHALL support search parameter 'organization' on PractitionerRole resource
**Requirement**: "Parameter `organization`:`reference` - Select PractitionerRoles available at the specified organization. Expression `PractitionerRole.organization`. The parameter may repeat in order to specify multiple values that must all be true (multipleAnd). The parameter may have multiple values (separated by comma) where at least one must be true (multipleOr). Chains Allowed: name, address, partof, type"
**Context**: This search parameter enables querying PractitionerRole resources by their organization reference, with support for multiple value combinations and chained searches on organization attributes including name, address, partof, and type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-046
**ID**: 46
**Summary**: Server SHALL support search parameter 'administered-by' on InsurancePlan resource
**Requirement**: "Parameter `administered-by`:`reference` - Select products that are administered by the specified organization. Expression `InsurancePlan.administeredBy`. The parameter may repeat in order to specify multiple values that must all be true (multipleAnd). The parameter may have multiple values (separated by comma) where at least one must be true (multipleOr). Chains Allowed: name, partof"
**Context**: This search parameter enables querying InsurancePlan resources by the organization that administers them, with support for multiple value combinations and chained searches on organization name and partof attributes.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-047
**ID**: 47
**Summary**: Server SHALL support search parameter 'organization' on HealthcareService resource
**Requirement**: "Parameter `organization`:`reference` - Select HealthcareServices provided by the specified organization. Expression `HealthcareService.providedBy`. The parameter may repeat in order to specify multiple values that must all be true (multipleAnd). The parameter may have multiple values (separated by comma) where at least one must be true (multipleOr). Chains Allowed: name, address, partof, type"
**Context**: This search parameter enables querying HealthcareService resources by the organization that provides them (via providedBy element), with support for multiple value combinations and chained searches on organization attributes including name, address, partof, and type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-048
**ID**: 48
**Summary**: Server SHALL support search parameter 'coverage-area' on HealthcareService resource
**Requirement**: "Parameter `coverage-area`:`reference` - Select services available in a region described by the specified location. Expression `HealthcareService.coverageArea`. The parameter may repeat in order to specify multiple values that must all be true (multipleAnd). The parameter may have multiple values (separated by comma) where at least one must be true (multipleOr)"
**Context**: This search parameter enables querying HealthcareService resources by their coverage area (geographic region where services are available), with support for multiple value combinations using AND and OR logic.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-049
**ID**: 49
**Summary**: Server SHALL support search by network parameter on PractitionerRole resource
**Requirement**: "Parameter `network`:`reference` [SHALL be supported to] Select roles where the practitioner is a member of the specified health insurance provider network"
**Context**: This search parameter allows querying PractitionerRole resources based on the health insurance provider network the practitioner is a member of. The parameter uses the expression `PractitionerRole.extension.where(url='http://hl7.org/fhir/us/davinci-pdex-plan-net/StructureDefinition/network-reference')` to search within the network-reference extension. The parameter supports multipleAnd (parameter may repeat to specify multiple values that must all be true) and multipleOr (parameter may have multiple comma-separated values where at least one must be true). Allowed chains include: name, address, partof, type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-050
**ID**: 50
**Summary**: Server SHALL support search by network parameter on OrganizationAffiliation resource
**Requirement**: "Parameter `network`:`reference` [SHALL be supported to] Select roles where the organization is a member of the specified health insurance provider network"
**Context**: This search parameter allows querying OrganizationAffiliation resources based on the health insurance provider network the organization is a member of. The parameter uses the expression `OrganizationAffiliation.network` to search the network element. The parameter supports multipleAnd (parameter may repeat to specify multiple values that must all be true) and multipleOr (parameter may have multiple comma-separated values where at least one must be true). Allowed chains include: name, partof.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-051
**ID**: 51
**Summary**: Server SHALL support search by location parameter on OrganizationAffiliation resource
**Requirement**: "Parameter `location`:`reference` [SHALL be supported to] Select OrganizationAffiliations available at the specified location"
**Context**: This search parameter allows querying OrganizationAffiliation resources based on the location where the affiliation is available. The parameter uses the expression `OrganizationAffiliation.location` to search the location element. The parameter supports multipleAnd (parameter may repeat to specify multiple values that must all be true) and multipleOr (parameter may have multiple comma-separated values where at least one must be true). Allowed chains include: address, address-postalcode, address-city, address-state, organization, type.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-052
**ID**: 52
**Summary**: Server SHALL support primary-organization search parameter on OrganizationAffiliation
**Requirement**: "Parameter `primary-organization`:`reference` [SHALL be supported to] Select roles offered by the specified organization"
**Context**: The Plan-Net Implementation Guide defines a search parameter for OrganizationAffiliation resources that allows searching by the primary organization. The search parameter uses the expression `OrganizationAffiliation.organization` and targets Organization resources. This search parameter supports multipleAnd (parameter may repeat to specify multiple values that must all be true) and multipleOr (parameter may have multiple values separated by comma where at least one must be true). Allowed chains include: type, address, name, partof.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-053
**ID**: 53
**Summary**: Server SHALL support participating-organization search parameter on OrganizationAffiliation
**Requirement**: "Parameter `participating-organization`:`reference` [SHALL be supported to] Select roles filled by the specified organization"
**Context**: The Plan-Net Implementation Guide defines a search parameter for OrganizationAffiliation resources that allows searching by the participating organization. The search parameter uses the expression `OrganizationAffiliation.participatingOrganization` and targets Organization resources. This search parameter supports multipleAnd (parameter may repeat to specify multiple values that must all be true) and multipleOr (parameter may have multiple values separated by comma where at least one must be true). Allowed chains include: type, address, name, partof.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
**Context**: This requirement constrains the behavior of client applications that query the Plan-Net service. Applications must not transmit any information that could identify individual consumers when making queries to the directory service. This is a complementary privacy protection to REQ-63, ensuring privacy from the client side.
**Conformance**: SHALL NOT
**Actor**: Application Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-172
**ID**: 172
**Summary**: Health Plan API Actor SHALL support all profiles defined in this Implementation Guide
**Requirement**: "This implementation guide defines a FHIR interface to a health insurer's insurance plans, their associated networks, and the organizations and providers that participate in these networks."
**Context**: The PDEX Payer Network Implementation Guide defines a standard FHIR interface that health insurers must implement to expose their provider directory data. This requirement establishes that the Health Plan API Actor must support all profiles defined within this IG to enable third-party applications to query network information.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-173
**ID**: 173
**Summary**: API is query-only and does not support PUT or POST
**Requirement**: "This is a query only API (GET) and does not support PUT or POST."
**Context**: The Plan-Net API is designed as a read-only interface for querying provider directory information. The Health Plan API Actor must only support GET operations and must not implement PUT or POST operations on this interface.
**Conformance**: SHALL NOT
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
...
# REQ-391
**ID**: 198
**Summary**: Plan-Net Organization NPI identifier system requirement
**Requirement**: "The [Plan-Net Organization identifier:NPI] system [element] SHALL be present with fixed value 'http://hl7.org/fhir/sid/us-npi'."
**Context**: When the NPI identifier slice is used, the system element must be present with cardinality 1..1 and must have the fixed value indicating the NPI namespace.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: True
...
# REQ-392
**ID**: 199
**Summary**: Plan-Net Organization CLIA identifier system requirement
**Requirement**: "The [Plan-Net Organization identifier:CLIA] system [element] SHALL be present with fixed value 'urn:oid:2.16.840.1.113883.4.7'."
**Context**: When the CLIA identifier slice is used, the system element must be present with cardinality 1..1 and must have the fixed value indicating the CLIA OID namespace.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: True
...
# REQ-393
**ID**: 200
**Summary**: Plan-Net Organization NAIC identifier system requirement
**Requirement**: "The [Plan-Net Organization identifier:NAIC] system [element] SHALL be present with fixed value 'urn:oid:2.16.840.1.113883.6.300'."
**Context**: When the NAIC identifier slice is used, the system element must be present with cardinality 1..1 and must have the fixed value indicating the NAIC OID namespace.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: True
...
# REQ-394
**ID**: 201
**Summary**: Plan-Net Organization address text must ensure consistency with parts
**Requirement**: "Applications updating an address SHALL ensure that when both text and parts are present, no content is included in the text that isn't found in a part."
...
# REQ-452
**ID**: 259
**Summary**: PractitionerRole active element must be true
**Requirement**: "Whether this practitioner role record is in active use [SHALL have] Required Pattern: true"
**Context**: The PractitionerRole.active element is mandatory (cardinality 1..1) and must have a value of true. This indicates that the practitioner role record is currently in active use.
**Conformance**: SHALL
**Actor**: Health Plan API Actor
**Sub-Requirement(s)**: NA
**Conditionality**: False
